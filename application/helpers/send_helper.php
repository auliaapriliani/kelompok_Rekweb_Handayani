...
function cek_session_mahasiswa(){
    $ci = & get_instance();
    $session = $ci->session->userdata('isLoggedInMahasiswa');
    if ($session == ''){
        redirect(base_url());
    }
}
...
//  function toBase64($image_location) {
...
<div class="preloader">
  <div class="loading" style="margin-top:-150px;">
    <img src="assets/img/icon/loader.gif" width="100">
...
return $load;
        ...
        function notifikasi($result,$value){

          /** required external file - how to use notification with sweetalert **/
          /** <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script> **/
          /** <link href="<?php echo base_url('assets/bootstrap/bootstrap-sweetalert/dist/sweetalert.css')?>"> **/
          ...
          /**      $result     = $notifikasi['result']; **/
          /**      $value      = $notifikasi['value']; **/
          /**      echo notifikasi($result,$value); **/
          /**  ?> **/
