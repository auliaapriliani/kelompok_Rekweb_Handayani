...
class Persalinan_model extends CI_Model {
	...
	{
		$this->db->from('k_persalinan_ibu');
        $this->db->join('tbl_pasien','k_persalinan_ibu.nik = tbl_pasien.nik');
		$this->db->where('k_persalinan_ibu.nik',$id);
		$query = $this->db->get();
	...
	{
		$this->db->insert('k_persalinan_ibu', $data);
	...
	{
		$this->db->where('id_persalinan_ibu', $id);
